...
export type LaunchesHistoryQueryVariables = Exact<{
  limit?: Maybe<Scalars['Int']>;
}>;


export type LaunchesHistoryQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'details' | 'flight_number'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'article_link' | 'mission_patch_small'>
    )> }
  )>>> }
);
...
export type LaunchInfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'details'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
...
export const LaunchesHistoryDocument = gql`
...
/**
 * __useLaunchesHistoryQuery__
 *
 * To run a query within a React component, call `useLaunchesHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchesHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchesHistoryQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useLaunchesHistoryQuery(baseOptions?: Apollo.QueryHookOptions<LaunchesHistoryQuery, LaunchesHistoryQueryVariables>) {
        return Apollo.useQuery<LaunchesHistoryQuery, LaunchesHistoryQueryVariables>(LaunchesHistoryDocument, baseOptions);
      }
export function useLaunchesHistoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesHistoryQuery, LaunchesHistoryQueryVariables>) {
          return Apollo.useLazyQuery<LaunchesHistoryQuery, LaunchesHistoryQueryVariables>(LaunchesHistoryDocument, baseOptions);
        }
export type LaunchesHistoryQueryHookResult = ReturnType<typeof useLaunchesHistoryQuery>;
export type LaunchesHistoryLazyQueryHookResult = ReturnType<typeof useLaunchesHistoryLazyQuery>;
export type LaunchesHistoryQueryResult = Apollo.QueryResult<LaunchesHistoryQuery, LaunchesHistoryQueryVariables>;
